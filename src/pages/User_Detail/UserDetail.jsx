...
const UserDetail = () => {
  ...
  return (
    <div
  className="max-w-2xl mx-4 mt-40 text-gray-900 bg-white rounded-lg shadow-xl sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto"
>
